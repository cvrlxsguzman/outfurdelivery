...
<head>
    ...
    <title>Out Fur Delivery | Past Boxes | Halloween Boxes 2020</title>
</head>
<body>
...
<div class="container shadow-lg p-0">
    ...
    <div class="row">
        <div class="col-md-4 pl-5 pr-5 pb-3">
            <img src="images/pastBoxes/tier-box-special-halloween-2.png" class="img-fluid">
        </div>
        <div class="col-md-4 pl-5 pr-5 pb-3">
            <img src="images/pastBoxes/tier-box-special-halloween-3.png" class="img-fluid">
        </div>
        <div class="col-md-4 pl-5 pr-5 pb-3">
            <img src="images/pastBoxes/tier-box-special-halloween-4.png" class="img-fluid">
        </div>
    </div>
</div>
