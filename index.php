...
<head>
    ...
    <title>Out Fur Delivery | Home</title>
</head>
<body>
...
<div class="container shadow-lg p-0">
    <div class="homeBanner">
        <img src="images/banners/dogandcat.jpg" alt="Home Dog Banner" class="img-fluid m-auto">
    </div>

    <div class="homePlan p-5">
        <div class="row pb-3">
            <h1 class="w-100 m-auto">Choose a Monthly Subscription</h1>
        </div>
        <div class="row w-75 m-auto">
            <div class="col-lg-4  pb-3">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/pawPackages/tier-box-basic.png" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-4 pb-3">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/pawPackages/tier-box-premium.png" class="img-fluid">
                    </div>
                    <div class="card-header-pills p-3">
            ...
            <div class="col-lg-4 pb-3">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/pawPackages/tier-box-professional.png" class="img-fluid">
                    </div>
                    <div class="card-header-pills p-3">
                        <h2 class="text-dark">Professional Paw Package</h2>
                    </div>
                    <div class="card-body">
                        <?php
                        if (isset($_SESSION["logged_in"])) { ?>
...
<div class="container shadow-lg">
    <div class="homeProducts p-5">
        <h1 class="w-50 m-auto pb-5">Our Products</h1>
        <h2 class="w-50 m-auto pb-5 text-dark">All products are pet approved and made with care at Out Fur Delivery</h2>

        <div class="row">
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/inHouseProducts/dark-blue-paw-printed-dog-bed.png" class="img-fluid">
                    </div>
<!--                    <div class="card-body">-->
<!--                        <a href="#" class="btn text-light p-3 rounded-pill">Order Now</a>-->
<!--                    </div>-->
                </div>
            </div>
            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/inHouseProducts/4-pack-slotted-cat-ball-toy.png" class="img-fluid">
                    </div>
<!--                    <div class="card-body">-->
<!--                        <a href="#" class="btn text-light p-3 rounded-pill">Order Now</a>-->
<!--                    </div>-->
            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/inHouseProducts/orange-and-blue-starfish-and-life-ring-squeaky-dog-chew-toys.png" class="img-fluid">
                    </div>
<!--                    <div class="card-body">-->
<!--                        <a href="#" class="btn text-light p-3 rounded-pill">Order Now</a>-->
<!--                    </div>-->
            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/inHouseProducts/pawprint-cat-bed.png" class="img-fluid">
                    </div>
<!--                    <div class="card-body">-->
<!--                        <a href="#" class="btn text-light p-3 rounded-pill">Order Now</a>-->
<!--                    </div>-->
            ...
            <div class="col">
                <div class="card shadow-lg">
                    <div class="card-img">
                        <img src="images/inHouseProducts/dog-tennis-ball-and-food-launcher.png" class="img-fluid">
                    </div>
<!--                    <div class="card-body">-->
<!--                        <a href="#" class="btn text-light p-3 rounded-pill">Order Now</a>-->
<!--                    </div>-->
...
<div class="container shadow-lg p-0">
    <h1 class="homeBrand w-50 m-auto p-5">Brand Name Products</h1>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="images/home/banner-cat-chicken&turkey.png" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/home/banner-dog-food.png" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/home/banner-organix.png" alt="Third slide">
            </div>
        </div>
...
<div class="container shadow-lg">
    <div class="homeSocial p-5">
        <div class="row pb-3">
            <h1 class="w-50 m-auto pb-5">Reviews From Customers</h1>
        </div>
        <div class="row">
            <div class="col-lg-6">
            <h1 class="pb-2">New on Social Media</h1>
                <div class="row pb-3">
                    <div class="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/cat.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    ...
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/dog-with-1-out-of-2-pack-dog-ball-toy.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/cat1.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row pb-3">
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/dog-with-mustard-colored-dog-bone.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/cat-with-outfurdeliverybox.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/dog-with-red-blue-life-preserver-squeaky-chew-toy.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row pb-3">
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/dog-with-stuffed-moose-dog-plushie.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/dog-with-tennis-ball-from-tennis-ball-launcher.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div CLASS="col">
                        <div class="card">
                            <div class="card-img">
                                <img src="images/social/catnip-box.png" class="img-thumbnail">
                            </div>
                        </div>
                    </div>
                </div>
